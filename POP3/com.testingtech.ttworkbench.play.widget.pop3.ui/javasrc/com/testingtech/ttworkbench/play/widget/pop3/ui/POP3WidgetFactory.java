...
public class POP3WidgetFactory 
extends AbstractDashboardWidgetFactory<POP3Model, PROTO_Interface.ACTIONS.BlockingInterface> {

  public IDashboardWidget<POP3Model> create(IDashboard dashboard) {
    return new POP3Widget(this, dashboard);
  }
}
