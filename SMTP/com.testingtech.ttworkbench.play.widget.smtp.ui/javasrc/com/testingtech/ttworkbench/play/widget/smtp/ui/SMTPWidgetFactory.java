...
public class SMTPWidgetFactory 
extends AbstractDashboardWidgetFactory<ISMTPModel, PROTO_Interface.ACTIONS.BlockingInterface> {
	
	public IDashboardWidget<ISMTPModel> create(IDashboard dashboard) {
		return new SMTPWidget(this, dashboard);
	}
}
